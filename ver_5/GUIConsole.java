...
public class GUIConsole {
  ...
  public static void display(Object msg) {
    JOptionPane.showMessageDialog(null, "" + msg.toString(), "Display",
        JOptionPane.INFORMATION_MESSAGE);
  }
  ...
  public static Integer readInt(String prompt) {
    ...
    while (!valid) {
      try {
        String input = JOptionPane.showInputDialog(null, prompt, "Input",
  ...
  public static Double readDouble(String prompt) {
    ...
    while (!valid) {
      try {
        ...
        JOptionPane.showMessageDialog(null, "Please enter an double.", "Error",
